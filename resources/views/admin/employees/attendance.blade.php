                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($employee->attendanceToday)
                                        <td><h6>
                                            <span class="badge badge-pill badge-success">Terekam</span></h6></td>
                                        <td>
                                        ...
                                        <?php if($employee->attendanceToday->time<=9 && $employee->attendanceToday->time>=7) { ?>
                                            <td><h6><span class="badge badge-pill badge-success">Hadir Tepat Waktu</span></h6></td>
                                        <?php } elseif ($employee->attendanceToday->time>9 && $employee->attendanceToday->time<=17) {
                                            ?><td><h6><span class="badge badge-pill badge-warning">Hadir Terlambat</span></h6></td><?php
                                        } else {
                                           ?><td><h6><span class="badge badge-pill badge-danger">Absensi Tidak Valid</span></h6></td><?php
                                        } ?>
                                            <td>
                                    ...
                                    @else
                                        <td><h6><span class="badge badge-pill badge-danger">Belum Ada Riwayat</span></h6></td>
                                        <td><h6><span class="badge badge-pill badge-danger">Belum Ada Riwayat</span></h6></td>
                                        <td><h6><span class="badge badge-pill badge-danger">Belum Ada Riwayat</span></h6></td>
                                        <td><h6><span class="badge badge-pill badge-danger">Belum Ada Riwayat</span></h6></td>
                                    @endif
