...
<nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
        <h5 class="brand-text font-weight-light text-center text-white pt-1">SISTEM INFORMASI PENGAJUAN IJIN DAN CUTI KARYAWAN</h5>
    </ul>
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                ...
                @else
                <img src="{{ asset ('img/user (3).png') }}" class="user-image img-circle elevation-2 alt="User Image">
                @endif
