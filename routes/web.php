...
Route::namespace('Admin')->prefix('admin')->name('admin.')->middleware(['auth','can:admin-access'])->group(function () {
    ...
    //Export Pdf//
    Route::get('/export/data/{employee}', 'ExportController@exportByEmployee')->name('export.data.employee');
    Route::get('/export/data-range', 'ExportController@exportByDateRange')->name('export.harian');
